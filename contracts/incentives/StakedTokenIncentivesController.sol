 ...
 * @notice Distributor contract for rewards to the Omnidex protocol, using a staked token as rewards asset.
 * The contract stakes the rewards before redistributing them to the Omnidex protocol participants.
