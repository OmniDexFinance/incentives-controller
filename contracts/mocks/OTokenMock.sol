...
import {IOToken} from '@aave/aave-stake/contracts/interfaces/IOToken.sol';

contract OTokenMock is IOToken {
  IOmnidexIncentivesController public _aic;
  ...
  constructor(IOmnidexIncentivesController aic) public {
    _aic = aic;
  }
